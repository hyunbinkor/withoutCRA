    ...
    <tr className="filetree-tab">
      <td className="filetree-tab-line">
        <div className="filetree-tab-line-left">
          {/* img도 뭔가 따로 처리 필요 */}
          <img
            src="./assets/main-filetree-tab-line-left-usericon.png"
            alt=""
            className="filetree-tab-line-left-usericon"
          />
          <Text
            fontSize="px14"
            color="black"
          ...
          <Text
            ...
            text={
              ...
              `(#${lastCommit.mergeNumber})`
            }
          />
          {/* Lastcommit.isCommitSucceded로 svg 분기 처리 */}
          <svg
            className="filetree-tab-line-left-githubaction"
            aria-hidden="true"
            focusable="false"
            role="img"
            viewBox="0 0 16 16"
