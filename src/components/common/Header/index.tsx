    ...
    <header>
      <FlexContainer tag='nav' className='header-upper'>
        <FlexContainer className='header-upper-left' justifyContents='left'>
            ...
            />
          <FlexContainer className='header-upper-left-repository' justifyContents='left'>
            <Button
        ...
        <FlexContainer className='header-upper-right' justifyContents='right'>
          ...
          <FlexContainer className='header-upper-right-buttons' justifyContents='right'>
            <Button
              btnIcon='create'
              btnHasToggle
              btnHasBorder
          ...
          <div className="header-upper-right-user">
            <img className="header-upper-right-user-icon" src={userIcon} alt=""/>
          </div>
        </FlexContainer>
      </FlexContainer>
